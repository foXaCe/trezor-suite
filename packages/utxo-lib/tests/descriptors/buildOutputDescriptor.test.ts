import { buildOutputDescriptor } from '@trezor/utxo-lib/src/descriptors/buildOutputDescriptor';
...
describe('utils/buildOutputDescriptor', () => {
    describe('passthrough', () => {
        it('returns descriptor as-is when provided', () => {
            ...
            const precomputed = 'wpkh([00000000/84h/0h/0h]xpub.../<0;1>/*)#checksum';
            expect(
                buildOutputDescriptor({ account: 0, xpub: XPUB, descriptor: precomputed }),
            ).toBe(precomputed);
        });
    });
    ...
    describe('purpose inference from scriptType', () => {
        it('defaults to SPENDADDRESS when neither purpose nor scriptType given', () => {
            ...
            expect(result).toMatch(/^pkh\(/);
            expect(result).toContain("/44'/0'/0'");
        });
        ...
        it('infers purpose 49 from SPENDP2SHWITNESS', () => {
            ...
            expect(result).toContain("/49'/0'/0'");
        });
        ...
        it('infers purpose 84 from SPENDWITNESS', () => {
            ...
            expect(result).toContain("/84'/0'/0'");
        });
    });
    ...
    describe('path construction', () => {
        ...
        it('uses coin_type 1 for Testnet', () => {
            ...
            expect(result).toContain("/84'/1'/0'");
        });
        ...
        it('uses the correct account index', () => {
            ...
            expect(result).toContain("/84'/0'/2'");
        });
    ...
    describe('SLIP25', () => {
        it('appends /1h for SLIP25 taproot', () => {
            ...
            expect(result).toContain("/10025'/0'/0'/1'");
        });
    ...
    describe('invalid inputs return undefined', () => {
        ...
        it('returns undefined for unknown purpose', () => {
            expect(
                buildOutputDescriptor({ account: 0, purpose: 999, xpub: XPUB }),
            ).toBeUndefined();
        });
