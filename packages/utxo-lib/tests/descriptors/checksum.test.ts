...
describe('getDescriptorChecksum', () => {
    ...
    it('with receive and change descriptor (BIP389)', () => {
        const fromAllSeed = 'wpkh([5c9e228d/84h/0h/0h]xpub6DDUPHpUo4pcy43iJeZjbSVWGav1SMMmuWdMHiGtkK8rhKmfbomtkwW6GKs1GGAKehT6QRocrmda3WWxXawpjmwaUHfFRXuKrXSapdckEYF/<0;1>/*)';
    ...
    it('with received descriptor (Bitcoin Core)', () => {
        const fromAllSeed = 'wpkh([5c9e228d/84h/0h/0h]xpub6DDUPHpUo4pcy43iJeZjbSVWGav1SMMmuWdMHiGtkK8rhKmfbomtkwW6GKs1GGAKehT6QRocrmda3WWxXawpjmwaUHfFRXuKrXSapdckEYF/0/*)';
        const expectedChecksum = 'vyj8qz0q';
        expect(getDescriptorChecksum(fromAllSeed)).toBe(expectedChecksum);
    });

    it('with change descriptor (Bitcoin Core)', () => {
        const fromAllSeed = 'wpkh([5c9e228d/84h/0h/0h]xpub6DDUPHpUo4pcy43iJeZjbSVWGav1SMMmuWdMHiGtkK8rhKmfbomtkwW6GKs1GGAKehT6QRocrmda3WWxXawpjmwaUHfFRXuKrXSapdckEYF/1/*)';
